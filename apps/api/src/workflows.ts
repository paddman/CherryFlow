...
const reportGenerator: WorkflowDefinition = {
  ...
  graph: {
    ...
    nodes: [
      ...
      { id: "qwen_pdf", moduleType: "report.qwen_pdf", config: { inputNode: "input", fileNode: "inspect", composeNode: "compose" } },
      { id: "output", moduleType: "core.output", config: { sourceNode: "qwen_pdf" } },
    ],
    edges: [
      { from: "input", to: "inspect" },
      { from: "input", to: "compose" },
      { from: "inspect", to: "compose" },
      { from: "input", to: "qwen_pdf" },
      { from: "inspect", to: "qwen_pdf" },
      { from: "compose", to: "qwen_pdf" },
      { from: "qwen_pdf", to: "output" },
    ],
    outputNodeId: "output",
  },
};
