...
export function StaticSection({ component }: { component: UiComponent }) {
  ...
  if (component.type === "cta") return <section id={component.id} className="ctaSection"><div><h2>{component.title}</h2>{component.body && <p>{component.body}</p>}</div><strong>{component.buttonLabel}</strong></section>;
