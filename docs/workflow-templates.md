...
CherryFlow includes 31 runnable workflow templates. Each template has a real Workflow Contract, executable graph, form inputs, output bindings, and metadata for the Template Gallery.
...
Most templates use the reusable `ai.task` module:
